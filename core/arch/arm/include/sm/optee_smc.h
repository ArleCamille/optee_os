...
#define OPTEE_SMC_GPU_FAST_CALL_VAL(func_num) \
	OPTEE_SMC_CALL_VAL(OPTEE_SMC_64, OPTEE_SMC_FAST_CALL, \
				OPTEE_SMC_OWNER_GPU, (func_num))
...
#define OPTEE_SMC_OWNER_GPU	U(52)
...
#define OPTEE_SMC_GPU_FUNC_LOCK_MEMORY	U(2)
#define OPTEE_SMC_GPU_LOCK_MEMORY \
	OPTEE_SMC_GPU_FAST_CALL_VAL(OPTEE_SMC_GPU_FUNC_LOCK_MEMORY)

#define OPTEE_SMC_GPU_FUNC_SURVEY_MEMORY	U(3)
#define OPTEE_SMC_GPU_SURVEY_MEMORY \
	OPTEE_SMC_GPU_FAST_CALL_VAL(OPTEE_SMC_GPU_FUNC_SURVEY_MEMORY)

#define OPTEE_SMC_GPU_FUNC_UNLOCK_MEMORY	U(4)
#define OPTEE_SMC_GPU_UNLOCK_MEMORY \
	OPTEE_SMC_GPU_FAST_CALL_VAL(OPTEE_SMC_GPU_FUNC_UNLOCK_MEMORY)
